...
<div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#"> Barcode & POS</a>
            </div>
            <!-- /.navbar-header -->
...
<!-- *****************************insert links to the specific pages********************************** -->
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                        ...
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    ...
                                    <div><h3>Customer Leads!</h3></div>
                                </div>
                            </div>
                        </div>
                        <a href="customerLeads.htm">
                            <div class="panel-footer">
                                <span class="pull-left">View Customer Leads</span>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                <div class="clearfix"></div>
                            </div>
                        </a>
                        ...
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    ...
                                    <div><h3>Marketing &  Media</h3></div>
                                </div>
                            </div>
                        </div>
                        <a href="salesmarketing.htm">
                            <div class="panel-footer">
