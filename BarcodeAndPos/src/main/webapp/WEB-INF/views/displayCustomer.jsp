...
<div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Display Customer Details</h1>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>${customer.performedDemonstration }</td>
                                            <td>${customer.multiLocation }</td>
                                            <td>${customer.opportunity }</td>
                                            <td>${customer.quoteAmount }</td>
