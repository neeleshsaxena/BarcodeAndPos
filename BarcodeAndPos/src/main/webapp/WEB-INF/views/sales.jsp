			...
			<div class="navbar-default sidebar" role="navigation">
				<div class="sidebar-nav navbar-collapse">
					<ul class="nav" id="side-menu">
						...
						<li><a href="dashboard.htm"><i class="fa fa-dashboard fa-fw"></i>
								Dashboard</a></li>
...
<!-- ************************************sales representative information********************************* -->
		...
		<div id="page-wrapper">
			<div class="container-fluid">
				<div class="row">
					<div class="col-lg-12">
						<h1 class="page-header">Sales Page</h1>
						...
						<!-- ***********link to marketing and social media page******************** -->
						<hr>
						<a class="fancybox" href="sales&marketing.htm?smedia=${socialMediaPerson }&market=${marketing}"><strong>Marketing and Social Media</strong></a>
						<table class="table">
                                    <thead>
